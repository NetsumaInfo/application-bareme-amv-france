    ...
    <Card>
      ...
      <div className="space-y-2">
        <div className={ROW}>
          ...
          <SettingsToggle checked={confirmClipDeletion} onChange={onToggleConfirmClipDeletion} ariaLabel={t('Avertissement avant suppression de clip')} />
        </div>
      </div>
    </Card>
  )
    ...
    <Card>
      ...
      <div className="space-y-2">
        <div className={ROW}>
          ...
          <SettingsToggle checked={showTooltips} onChange={onToggleShowTooltips} ariaLabel={t('Afficher les info-bulles')} />
        </div>
      </div>
    </Card>
  )
