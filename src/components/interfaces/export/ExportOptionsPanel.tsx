import { Code2, Download, FileImage, FileJson, FileSpreadsheet, FileText, Loader2 } from 'lucide-react'
...
interface NotesExportSettingsProps {
...
function NotesExportSettings({
  notesPdfMode,
  includeTimecodeThumbnails,
  onSetNotesPdfMode,
  onToggleTimecodeThumbnails,
}: NotesExportSettingsProps) {
  const { t } = useI18n()
  return (
    <>
      <div className="flex items-center justify-between gap-2">
...
interface JsonExportSettingsProps {
...
function JsonExportSettings({
  jsonExportMode,
  jsonJudgeKey,
  jsonJudgeOptions,
  onSetJsonExportMode,
  onSetJsonJudgeKey,
}: JsonExportSettingsProps) {
  const { t } = useI18n()
  return (
    <>
      <div className="flex items-center justify-between gap-2">
...
interface ExcelExportSettingsProps {
...
const TYPE_ORDER: ExportTableType[] = ['png', 'pdf', 'excel', 'html', 'notes', 'json']
        ...
        <div className="flex flex-col gap-1.5">
          ...
          {isImageType && (
            <ImageExportSettings
              ...
              exportTheme={exportTheme}
              onSetPngScale={onSetPngScale}
              onSetExportTheme={onSetExportTheme}
              onTogglePngTransparent={onTogglePngTransparent}
          ...
          {selectedType === 'notes' && (
            <NotesExportSettings
              ...
              onToggleTimecodeThumbnails={onToggleTimecodeThumbnails}
            />
          )}
          ...
          {selectedType === 'excel' && (
            <ExcelExportSettings
              ...
              onSetExcelLayout={onSetExcelLayout}
              onSetExcelOrientation={onSetExcelOrientation}
              onSetExcelSort={onSetExcelSort}
              onToggleExcelJudges={onToggleExcelJudges}
              onToggleExcelCategories={onToggleExcelCategories}
              onToggleExcelRank={onToggleExcelRank}
            />
          )}
