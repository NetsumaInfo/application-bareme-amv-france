...
- `useAppUpdateStore` — проверка обновлений через релизы GitHub; встроенное подписанное автообновление (tauri-plugin-updater) загружается и устанавливается прямо из приложения.
...
- встроенное автообновление: при наличии новой подписанной версии в шапке появляется синий логотип «Обновить»; по клику проект сохраняется, обновление скачивается, устанавливается, и приложение перезапускается.
